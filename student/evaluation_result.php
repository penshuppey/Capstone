...
<div class="col-lg-12">
	<div class="callout callout-info">
		<div class="d-flex w-100 justify-content-center align-items-center">
			<label for="faculty">Select Organization</label>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<table width="100%">
					<tr>
						<td width="50%"><p><b>Organization: <span id="fname"></span></b></p></td>
					...
					<tr>
						...
						<td width="50%"><p><b>President: <span id="subjectField"></span></b></p></td>
					</tr>
			</table>
